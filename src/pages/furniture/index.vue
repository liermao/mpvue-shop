  ...
  <div>
    ...
    <scroll-view scroll-x="true"
      ...
      <div class="name"
           ...
           @tap="toContent(index)">{{item.name}}
      </div>
    </scroll-view>
    <div class="screen">
      <div class="screen-box">
        <h3  @click="spaceFun"><span>{{spaceTxt}}</span><img src="http://47.98.180.219:10085/static/images/icon/down.png"></h3>
        <div class="space" v-show="spaceShow">
          <ul>
            <li v-for="(item,index) in space"   :class="index===spaceIndex ? 'active' : ''" :key="index" @click="spaceSelect(index,item.id,item.name)">{{item.name}}</li>
          </ul>
        </div>
      </div>
      <div class="screen-box">
        <h3><span>风格</span><img src="http://47.98.180.219:10085/static/images/icon/down.png"></h3>
      </div>
      <div class="screen-box">
        <h3><span>价格</span><img src="http://47.98.180.219:10085/static/images/icon/down.png"></h3>
      </div>
      <div class="screen-box">
        <h3><span>筛选</span><img src="http://47.98.180.219:10085/static/images/icon/down.png"></h3>
      </div>
    </div>
    <div class="list">
    <ul>
